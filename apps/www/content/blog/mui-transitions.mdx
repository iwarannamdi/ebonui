...
image: https://cdn.ebonui.com/assets/f3355d7a-4134-4c6d-87e5-254d11fa47ef.png
...
One way to start with MUI Transitions is to use ebonui’s startup landing page template. This solution includes pre-built transitions that help create a more interactive website that boosts user experience and keeps visitors engaged.
...
## Responsive Design with MUI and ebonui
...
ebonui, a [free and open-source UI](https://pro.ebonui.com/docs/templates/startup) library, can be used with MUI to create more responsive and visually appealing user interfaces. It offers a collection of pre-built animated components designed to work seamlessly with MUI.

### Benefits of Using ebonui

#### Extensive Collection of Pre-built Components

[ebonui provides various animated components](https://pro.ebonui.com/docs/templates/startup), including buttons, cards, modals, and more. This can save you time and effort when building your UI.

#### Seamless Integration with MUI

[ebonui components are designed](https://pro.ebonui.com/docs/templates/startup) to work seamlessly with MUI's theming and styling system, making integrating them into existing MUI projects easy.

#### Responsive Design Made Easy

[ebonui components are built](https://pro.ebonui.com/docs/templates/startup) with responsiveness in mind, so they automatically adapt to different screen sizes. This helps you create websites that look great on all devices.

#### Example

```javascript
import { ebonuiButton } from "@ebonui/react"
...
function MyComponent() {
  return (
    <div>
      ...
      <ebonuiButton variant="primary">ebonui Button</ebonuiButton>
    </div>
  )
}
```
...
In this example, we've used MUI's Button and [ebonui's ebonuiButton components](https://pro.ebonui.com/docs/templates/startup). Both components will be responsive and adapt to the screen size.

## Check Out Our React Component Library for Design Engineers

ebonui is a [free and open-source UI](https://pro.ebonui.com/docs/templates/startup) library specifically designed for design engineers. This library provides over 20 animated components built with React, TypeScript, Tailwind CSS, and Framer Motion.

ebonui offers a range of [visually appealing and interactive elements](https://pro.ebonui.com/docs/templates/startup) that can easily integrate into web applications, allowing for stunning user interfaces with minimal effort.
