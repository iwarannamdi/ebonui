...
image: https://cdn.ebonui.com/assets/d71b5583-8832-4504-978d-f6f635d23d73.png
...
![4 Tailwind buttons with varying border radius](https://cdn.ebonui.com/assets/sh6gjuuht5.png)
...
![4 Tailwind buttons with varying border radius](https://cdn.ebonui.com/assets/4hgdkrd90qv.png)
...
![4 Tailwind buttons with varying border radius](https://cdn.ebonui.com/assets/n88hvbhn9k.png)
...
- Create Custom Components: Use your new skills to create reusable React components with different border radii. We have written guides on using [Grid](https://ebonui.com/blog/tailwind-css-grid) and [Font Sizes](https://ebonui.com/blog/tailwind-font-size) in React that you can explore.
