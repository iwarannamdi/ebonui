---
title: Dark Theme
description: Using CSS Variables and color utilities for dark theme.
---

You can choose between using CSS variables (recommended) or utility classes for dark theme.
...
To use CSS variables for dark theme set `tailwind.cssVariables` to `true` in your `components.json` file.
...
To use utility classes for dark theme set `tailwind.cssVariables` to `false` in your `components.json` file.
