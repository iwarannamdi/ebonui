...
<ComponentPreview name="glow-border-demo" />
...
```bash
npx shadcn@latest add https://ebonui.com/r/styles/ebonui/glow-border.json
```
...
<ComponentSource name="glow-border" />
...
<ComponentPreview name="glow-border-demo-2" />
