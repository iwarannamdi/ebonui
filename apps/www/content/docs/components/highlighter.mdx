...
date: 2025-02-11
description: Text highlight that overlays text with a color.
author: pratiyank and modified by iwarannamdi
published: true
---
...
```bash
npx shadcn@latest add https://ebonui.com/r/highlighter.json
```
...
```tsx showLineNumbers
<Highlighter action="underline" color="#620e9aff" strokeWidth={2}>
  stunning designs
</Highlighter>
```
