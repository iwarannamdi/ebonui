---
title: Marquee
description: A customizable, interactive scrolling marquee component with various animation options, and responsive design.
component: true
---
...
```bash
npx shadcn@latest add https://ebonui.com/r/styles/ebonui/marquee.json
```
