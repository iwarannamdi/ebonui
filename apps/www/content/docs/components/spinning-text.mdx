---
title: Spinning Text
description: This is a component that animates a text with a shiny flash-like color.
component: true
---
...
```bash
npx shadcn@latest add https://ebonui.com/r/styles/ebonui/spinning-text.json
```
...
```tsx showLineNumbers
<AnimatedShinyText>Welcome to EbonUI</AnimatedShinyText>
```
