---
title: Terminal
description: An implementation of the linux terminal. Used for showcasing a command line interface.
component: true
---
...
```bash
npx shadcn@latest add https://ebonui.com/r/styles/ebonui/terminal.json
```
