...
```tsx title="registry/ebonui/hello-world/hello-world.tsx" showLineNumbers
...
<Callout className="mt-6">
  **Note:** This example places the component in the `registry/ebonui`
  ...
  "items": [
    {
      ...
      "files": [
        {
          "path": "registry/ebonui/hello-world/hello-world.tsx",
...
- Place your registry item in the `registry/[STYLE]/[NAME]` directory. I'm using `ebonui` as an example. It can be anything you want as long as it's nested under the `registry` directory.
...
- **Imports should always use the `@/registry` path.** eg. `import { HelloWorld } from "@/registry/ebonui/hello-world/hello-world"`
